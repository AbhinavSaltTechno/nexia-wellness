...
const HowDoes = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center bg-white py-32 min-h-40 black-nexia1">
      ...
      <div className="flex flex-nowrap gap-4 justify-evenly overflow-x-auto w-full [&::-webkit-scrollbar]:hidden [&::-ms-overflow-style:none] [&::-scrollbar-width:none] p-4 mx-auto md:px-16">
        {arr.map((ele, ind) => (
          <div
            title="Shift + scroll to move horizontally"
            key={ind}
          ...
          >
            ...
            <div className="min-w-16 h-16 md:h-36 md:min-w-36 relative mt-4">
              <Image src={ele.img} sizes="100vw" fill alt="the human" />
            </div>
          </div>
        ))}
      </div>
