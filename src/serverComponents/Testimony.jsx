...
const Testimony = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center py-32 min-h-40 black-nexia1">
      ...
      <div className="flex gap-4 justify-evenly overflow-x-auto w-full space-x-4 items-start [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none] p-4">
        ...
        {arr.map((ele, ind) => (
          ...
          >
            <div className="flex gap-4 items-center">
              ...
              <span className="font-bold text-xl nexiaBt2">{ele.user}</span>
            </div>
            <div className="text-base md:text-xl font-normal ">
              ...
              <div className="flex gap-3 nexiaBg1 rounded-b-3xl px-8 py-3 text-white">
                ...
                <div className="flex flex-col justify-center">
                  <span className="text-xl font-bold">{ele.DrName}</span>
